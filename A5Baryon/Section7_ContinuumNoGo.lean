/-
══════════════════════════════════════════════════════════════════════════════
  §7.3. Continuum No-go: Finite Local Holonomy vs Curvature
══════════════════════════════════════════════════════════════════════════════

  File     : A5Baryon/Section7_ContinuumNoGo.lean
  Paper    : §7.4 —  No-go （ 7.2, 7.3）
  ...
  :
    ...
    : Section7_ContinuumDefectNoGo.lean（§7.3 Defect/C₅ ）
  ──────────────────────────────────────────────────────────────────────
══════════════════════════════════════════════════════════════════════════════
-/
