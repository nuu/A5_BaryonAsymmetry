/-
══════════════════════════════════════════════════════════════════════════════
  OutA5Necessity.lean — Out(A₅) ≅ Z₂  
  The Out(A₅) Necessity Theorem and Power Map Distribution
══════════════════════════════════════════════════════════════════════════════

  File     : A5CosmicNecessity/OutA5Necessity.lean
  Paper    : "Algebraic Construction of Baryon Asymmetry from A₅ Holonomy"
             §4 — Claim 2
...
/-- **τ （A₅ ）** -/
theorem tau_not_in_A5 : ¬ (tau ∈ alternatingGroup (Fin 5)) := by
...
/--
  **A₅ ** —  (S2) 
  ...
  C₅⁺  C₅⁻ 
-/
theorem sigma_double_trans_not_commute :
...
theorem sakharov_algebraic_basis :
    ...
    (60 ^ 1 ≥ 2 ^ 5)
    :=
  ⟨sigma_double_trans_not_commute,
   odd_perm_maps_C5plus_to_C5minus,
   odd_perm_maps_C5minus_to_C5plus,
