/-
══════════════════════════════════════════════════════════════════════════════
  §7.3. Continuum vs Discreteness: Defect/Monodromy Reading (Lean Core)
══════════════════════════════════════════════════════════════════════════════

  File     : A5Baryon/Section7_ContinuumDefectNoGo.lean
  Paper    : §7.3 — No-go 「A」: / C₅ 
             （ 7.3 A ）
  ...
  :
    ...
    Section7_ContinuumNoGo.lean  No-go （ 7.2）:
      「smooth-local  +  = 」
    （ 7.3）
     No-go 「A」
     ...
     §7.4 （ 7.3）:
      A: （） →   ← 
               ρ : π₁(M \ Σ) → A₅
                Σ 
      B: （）                  ← Section7_LatticeGaugeAction.lean
  ...
  :
    ...
    : ConjugacyClassGalois.lean  (σ, σ², A5_IsConj, squaring maps)
            Section7_ContinuumNoGo.lean (MonodromyModel, FiniteHolonomyReading,
                                          7.2: smoothLocal_noGo,
                                          7.3: curvature_forces_not_local)
...
import A5Baryon.Section7_ContinuumNoGo
...
══════════════════════════════════════════════════════════════════════════════
  ...
  Phase 1–3 :
    (iii) +⇒ [TopologyFiniteConnected]
      → (v) smooth-local +  =  [Section7_ContinuumNoGo]
        → defect  []
          → C₅⁺/C₅⁻  [§3–§4]
-/
